...
class GlobalThemeStyle extends StatelessWidget {
  ...
  static Future<void> changeTheme(VoidCallback fun, [int? delay]) async {
    ...
    _globalThemeDuration.value = GlobalConfig.themeDuration;
    _globalThemeCurve.value = GlobalConfig.themeCurve;
    fun();
    _timer = () {
      _globalThemeDuration.value = null;
      _globalThemeCurve.value = null;
      _timer = null;
    }.delay(max(delay ?? 500, GlobalConfig.themeDuration.inMilliseconds));
  }
