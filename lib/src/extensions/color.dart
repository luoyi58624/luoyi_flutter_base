...
extension FlutterColorExtension on Color {
  ...
  /// 当用户鼠标悬停时的颜色
  Color onHover(BuildContext context, bool isHover, [int? scale]) => isHover ? deepen(scale ?? 6) : this;

  /// 当用户鼠标、手指按下时的颜色
  Color onTap(BuildContext context, bool isTap, [int? scale]) => isTap ? deepen(scale ?? 10) : this;
}
