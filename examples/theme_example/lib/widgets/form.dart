...
class FormWidgets extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ComponentDecoration(title: 'Form', children: [
      ...
      Column(
        children: [
          RadioListTile(title: const Text('Option 1'), value: 0, groupValue: radioValue.value, onChanged: (v) => radioValue.value = v!),
          RadioListTile(title: const Text('Option 2'), value: 1, groupValue: radioValue.value, onChanged: (v) => radioValue.value = v!),
          RadioListTile(title: const Text('Option 3'), value: 2, groupValue: radioValue.value, onChanged: (v) => radioValue.value = v!),
          RadioListTile(title: const Text('Option 4'), value: 3, groupValue: radioValue.value, onChanged: (v) => radioValue.value = v!),
        ],
      ),
      Column(
        children: [
          CheckboxListTile(title: const Text('Option 1'), value: checkboxValue.value, onChanged: (v) => checkboxValue.value = v!),
          CheckboxListTile(
